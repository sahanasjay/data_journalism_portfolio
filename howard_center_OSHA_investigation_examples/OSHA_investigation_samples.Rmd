...
##Sources
### This function is not written by me. It was created by one of my colleagues at the Howard Center, and served to create 
...
# Comparing the number of inspectionsper ten thousand workers in federal and state plan states 
```{r}
